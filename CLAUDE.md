...
└── YYYY-MM-DD-제목.md     # 날짜별 작업 로그
```

### 작업 시 규칙

1. **작업 시작**: 오늘 날짜의 로그 파일 존재 확인, 없으면 생성
2. **커밋 후**: PROJECT-STATUS.md에 커밋 정보 추가
3. **Phase 완료**: 진행률 업데이트, 다음 Phase 정보 기록
4. **세션 종료**: 미완료 작업을 "다음 작업"에 기록

### 로그 작성 명령

```
"개발 로그 작성해줘"      → 오늘 작업 내용 기록
"프로젝트 상태 업데이트"   → PROJECT-STATUS.md 업데이트
"오늘 작업 기록해줘"      → 날짜별 로그 파일 생성/업데이트
```
